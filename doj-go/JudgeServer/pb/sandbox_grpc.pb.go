...
const (
	...
	Executor_CopyFileIn_FullMethodName  = "/pb.Executor/CopyFileIn"
	Executor_CopyFileOut_FullMethodName = "/pb.Executor/CopyFileOut"
)
...
type ExecutorClient interface {
	...
	// 从sandbox复制进容器中，前提该文件已经被SyncFiles,返回FileID
	CopyFileIn(ctx context.Context, in *FileCopy, opts ...grpc.CallOption) (*FileID, error)
	// 从sandbox中复制文件到判题机，实现长时间存储
	CopyFileOut(ctx context.Context, in *FileCopy, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *executorClient) CopyFileIn(ctx context.Context, in *FileCopy, opts ...grpc.CallOption) (*FileID, error) {
	out := new(FileID)
	err := c.cc.Invoke(ctx, Executor_CopyFileIn_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executorClient) CopyFileOut(ctx context.Context, in *FileCopy, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Executor_CopyFileOut_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExecutorServer interface {
	...
	// 从sandbox复制进容器中，前提该文件已经被SyncFiles,返回FileID
	CopyFileIn(context.Context, *FileCopy) (*FileID, error)
	// 从sandbox中复制文件到判题机，实现长时间存储
	CopyFileOut(context.Context, *FileCopy) (*emptypb.Empty, error)
...
func (UnimplementedExecutorServer) CopyFileIn(context.Context, *FileCopy) (*FileID, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CopyFileIn not implemented")
}
func (UnimplementedExecutorServer) CopyFileOut(context.Context, *FileCopy) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CopyFileOut not implemented")
}
...
func _Executor_CopyFileIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FileCopy)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExecutorServer).CopyFileIn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Executor_CopyFileIn_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServer).CopyFileIn(ctx, req.(*FileCopy))
	}
	return interceptor(ctx, in, info, handler)
}

func _Executor_CopyFileOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FileCopy)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExecutorServer).CopyFileOut(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Executor_CopyFileOut_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServer).CopyFileOut(ctx, req.(*FileCopy))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Executor_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CopyFileIn",
			Handler:    _Executor_CopyFileIn_Handler,
		},
		{
			MethodName: "CopyFileOut",
			Handler:    _Executor_CopyFileOut_Handler,
		},
	},
